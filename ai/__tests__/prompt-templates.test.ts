...
describe("System Prompts", () => {
  describe("WORKOUT_SYSTEM_PROMPT", () => {
    ...
    it("should mention exercise library requirements", () => {
      ...
      expect(WORKOUT_SYSTEM_PROMPT).toContain("list_and_select_exercise");
    });

    it("should include progressive overload guidance", () => {
      expect(WORKOUT_SYSTEM_PROMPT.toLowerCase()).toContain(
  ...
  describe("STRATEGY_SYSTEM_PROMPT", () => {
    ...
    it("should include periodization types", () => {
      ...
      expect(STRATEGY_SYSTEM_PROMPT).toContain("BLOCK");
    ...
    it("should mention exercise search for goals", () => {
      ...
      expect(STRATEGY_SYSTEM_PROMPT).toContain("list_and_select_exercise");
...
describe("Tool Descriptions", () => {
  describe("SAVE_PERMANENT_NOTE_TOOL_DESCRIPTION", () => {
    ...
    it("should list what NOT to create notes for", () => {
      expect(SAVE_PERMANENT_NOTE_TOOL_DESCRIPTION).toContain(
  ...
  describe("GENERATE_NUTRITION_TARGETS_TOOL_DESCRIPTION", () => {
    it("should be a non-empty string", () => {
      ...
      expect(
        GENERATE_NUTRITION_TARGETS_TOOL_DESCRIPTION.length,
      ).toBeGreaterThan(10);
    });

    it("should mention nutrition targets", () => {
      expect(
        GENERATE_NUTRITION_TARGETS_TOOL_DESCRIPTION.toLowerCase(),
      ).toContain("nutrition");
      expect(
        GENERATE_NUTRITION_TARGETS_TOOL_DESCRIPTION.toLowerCase(),
      ).toContain("macro");
  ...
  describe("REQUEST_CLARIFICATION_TOOL_DESCRIPTION", () => {
    ...
    it("should give examples", () => {
      expect(REQUEST_CLARIFICATION_TOOL_DESCRIPTION).toContain(
        "EXAMPLE QUESTIONS",
      );
  ...
  describe("GENERATE_TRAINING_STRATEGY_TOOL_DESCRIPTION", () => {
    it("should be a non-empty string", () => {
      ...
      expect(
        GENERATE_TRAINING_STRATEGY_TOOL_DESCRIPTION.length,
      ).toBeGreaterThan(50);
    });

    it("should describe prerequisites", () => {
      expect(GENERATE_TRAINING_STRATEGY_TOOL_DESCRIPTION).toContain(
...
describe("Prompt Consistency", () => {
  ...
  it("should not contain deprecated tool names", () => {
    const deprecatedNames = [
      ...
      "batch_search_exercises",
      "create_workout", // should be generate_workout_plan
    ];

    deprecatedNames.forEach((name) => {
      expect(WORKOUT_SYSTEM_PROMPT).not.toContain(name);
      expect(STRATEGY_SYSTEM_PROMPT).not.toContain(name);
    });
  });
});
