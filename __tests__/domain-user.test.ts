...
describe('User Domain Contracts', () => {
  ...
  describe('FitnessExperience', () => {
    ...
    it.each(FITNESS_EXPERIENCES)('FitnessExperienceSchema should accept: %s', (value) => {
  ...
  describe('NotificationFrequency', () => {
    ...
    it.each(NOTIFICATION_FREQUENCIES)('NotificationFrequencySchema should accept: %s', (value) => {
  ...
  describe('AccountStatus', () => {
    ...
    it.each(ACCOUNT_STATUSES)('AccountStatusSchema should accept: %s', (value) => {
  ...
  describe('PregnancyStatus', () => {
    ...
    it.each(PREGNANCY_STATUSES)('PregnancyStatusSchema should accept: %s', (value) => {
    ...
    describe('calculateTrimesterFromDueDate', () => {
      it('should return postpartum when due date is in the past', () => {
        ...
        expect(calculateTrimesterFromDueDate(pastDate, refDate)).toBe('postpartum');
      });
      ...
      it('should return trimester_3 when due date is ~4 weeks away', () => {
        ...
        expect(calculateTrimesterFromDueDate(dueDate, refDate)).toBe('trimester_3');
      });

      it('should return trimester_1 when due date is ~38 weeks away', () => {
        const refDate = new Date('2025-01-01');
        // 38 weeks away = 266 days
        const dueDate = new Date(refDate.getTime() + 38 * 7 * 24 * 60 * 60 * 1000);
        expect(calculateTrimesterFromDueDate(dueDate, refDate)).toBe('trimester_1');
      });

      it('should return not_pregnant for invalid date', () => {
        expect(calculateTrimesterFromDueDate(new Date('invalid'))).toBe('not_pregnant');
      });
    });
  });
  ...
  describe('MessagingRecipientRole', () => {
    ...
    it('should have correct constant mappings', () => {
      expect(MESSAGE_RECIPIENT_ROLE.FITNESS_COORDINATOR).toBe('FITNESS_COORDINATOR');
  ...
  describe('Mock factories', () => {
    describe('createMockUserProfile', () => {
      ...
      it('should have correct defaults', () => {
        const profile = createMockUserProfile();
        expect(profile.userId).toBe('HH-ABC123');
    ...
    describe('createMockUserAccount', () => {
      ...
      it('should include a profile', () => {
        ...
        expect(account.profile.userId).toBe('HH-ABC123');
      });
    });
  });
});
