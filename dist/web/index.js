 ...
 */
import { accentColors, brandColors, chartPaletteDark, chartPaletteLight, darkColors, fontFamily, fontSizesCss, fontWeights, lightColors, lineHeightsCss, opacityCss, radiiCss, shadowsCss, spacingCss, transitionsCss, } from '../tokens/index.js';
// ─────────────────────────────────────────────────────────────────────────────
// THEME DEFINITIONS
// ─────────────────────────────────────────────────────────────────────────────
const baseWebTheme = {
 ...
 */
export function generateColorCssVariables(colors, prefix = '') {
    const lines = [];
 ...
 */
export function generateTailwindThemeBlock() {
 ...
 */
export function generateRootCssVariables() {
