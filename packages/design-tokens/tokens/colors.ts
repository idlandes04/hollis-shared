...
export const darkColors = {
  ...
  // Surfaces (Brand navy-based)
  background: brandColors.navy,
  surface: '#024060',
  surfaceElevated: '#035078',
  card: '#024060',
  ...
  // Inputs
  inputBackground: '#012A40',
  inputBorder: '#2A5A73',
  inputText: brandColors.offWhite,
  inputPlaceholder: '#5A7A90',

  // Navigation
  tabBarBackground: brandColors.navy,
  tabBarBorder: '#1A4A63',
  tabIconDefault: '#5A7A90',
  tabIconSelected: brandColors.lightBlue,

  headerBackground: brandColors.navy,
  headerText: brandColors.offWhite,

  // Modal/Overlay
  modalBackground: '#024060',
